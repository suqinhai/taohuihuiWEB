            ...
            <div v-if="!FormVisible">
                <el-col :span="19" class="toolbar" style="padding-bottom: 0px;">
                    <el-form :inline="true" :model="filters">
                        ...
                        <el-form-item>
                            <el-button size="small" type="primary" @click="handleOnline" :disabled="this.sels.length == 0">下线</el-button>
                        </el-form-item>
                    </el-form>
                </el-col>
                        ...
                        <template scope="props">
                            <el-form label-position="left" inline class="demo-table-expand">
                                <el-form-item label="剩余优惠券数量：">
                                    <span>{{ props.row.couponLeftCount }}</span>
                                </el-form-item>
                                <el-form-item label="优惠券总数：">
                                    <span>{{ props.row.couponTotalCount }}</span>
                                </el-form-item>
                                <el-form-item label="佣金百分比：">
                                    <span>{{ props.row.tkRate }}</span>
                                </el-form-item>
                                <el-form-item label="渠道：">
                                    <span v-if="props.row.userType == 0">淘宝</span>
                                    <span v-if="props.row.userType == 1">天猫</span>
                                </el-form-item>
                                <el-form-item label="优惠券信息：">
                                    <span>{{ props.row.couponInfo }}</span>
                                </el-form-item>
                                <el-form-item label="卖家店铺：">
                                    <span>{{ props.row.shopTitle }}</span>
                                </el-form-item>
                                <el-form-item label="优惠券开始时间：">
                                    <span>{{ props.row.couponEffectiveStartTime }}</span>
                                </el-form-item>
                                <el-form-item label="优惠券结束时间：">
                                    <span>{{ props.row.couponEffectiveEndTime }}</span>
                                </el-form-item>
                            </el-form>
                        </template>
                    </el-table-column>
...
export default {
    ...
    methods: {
        ...
        getData() {
            ...
            this.$http.get(this.interface.list.get + '?page=' + para.page + '&name=' + para.name + '&pageSize=' + this.per_page + '&publish=1').then((data) => {
